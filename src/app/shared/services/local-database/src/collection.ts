...
export class Collection {
  ...
  constructor(
    ...
    protected localDriverOnly?
  ) {
    this.loadDataFromLocalStorage().then(this.subscribeToDocs);
  }
  ...
  delete(document: any): Promise<boolean> {
    return new Promise<any>((res, rej) => {
      ...
      this.snackBar.open('Deleted!', 'Close', {duration: 1e3, panelClass: ['primary-snackbar']});
    });
  }
  ...
  create(document: any): Promise<any> {
    return new Promise<any>((res, rej) => {
      ...
      this.snackBar.open('Created!', 'Close', {duration: 1e3, panelClass: ['primary-snackbar']});
    });
  }
  ...
  update(document: any, upsert = false): Promise<any> {
    return new Promise<any>((res, rej) => {
      ...
      this.snackBar.open('Updated!', 'Close', {duration: 1e3, panelClass: ['primary-snackbar']});
    });
  }
